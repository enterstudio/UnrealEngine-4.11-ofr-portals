...
void UPrimitiveComponent::SetRenderPortal(bool bValue) {
    if (bRenderPortal != bValue) {
        bRenderPortal = bValue;
        MarkRenderStateDirty();
    }
}

void UPrimitiveComponent::SetPortalVisibilityGroup(EPortalVisibility eValue) 
{
    if (PortalVisibilityGroup != eValue) 
	{
		PortalVisibilityGroup = eValue;
        MarkRenderStateDirty();
    }
}
