...
public:
    ...
    /** If true, this component will be rendered as a Portal */
    UPROPERTY(EditAnywhere, AdvancedDisplay, BlueprintReadOnly, Category=Rendering, meta=(DisplayName = "Render As Portal"))
    uint32 bRenderPortal:1;
    
	/** Sets which portal visibility group this object is rendered in */
	UPROPERTY(EditAnywhere, AdvancedDisplay, BlueprintReadOnly, Category=Rendering)
    TEnumAsByte<enum EPortalVisibility> PortalVisibilityGroup;
...
public:
	...
	*/
    ...
    /** Sets the bRenderPortal property and marks the render state dirty. */
    UFUNCTION(BlueprintCallable, Category="Rendering")
    void SetRenderPortal(bool bValue);
    
    /** Sets the Portal visibility group property and marks the render state dirty. */
    UFUNCTION(BlueprintCallable, Category="Rendering")
    void SetPortalVisibilityGroup(EPortalVisibility eValue);
