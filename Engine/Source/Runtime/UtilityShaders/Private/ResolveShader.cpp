...
IMPLEMENT_SHADER_TYPE(template<>, FResolveDepth2xPS, TEXT("ResolvePixelShader"), TEXT("MainDepthMSAA"), SF_Pixel);
IMPLEMENT_SHADER_TYPE(template<>, FResolveDepth4xPS, TEXT("ResolvePixelShader"), TEXT("MainDepthMSAA"), SF_Pixel);
