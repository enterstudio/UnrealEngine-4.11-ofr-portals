...
public:
    ...
    /** Set of Portal prims for this view */
    FPortalPrimSet PortalPrimSet;

	/** Set of prims visible through portals for this view */
	FPortalPrimSet PortalVisiblePrimSet;
...
protected:
	...
	*/
    ...
    void RenderPortalPass(FRHICommandListImmediate& RHICmdList);
