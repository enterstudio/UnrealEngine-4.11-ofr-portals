...
protected:
	...
	void RenderForwardShadingBasePass(FRHICommandListImmediate& RHICmdList, ESceneDepthPriorityGroup, bool PortalVisibilePass);
	bool RenderForwardShadingBasePassView(FRHICommandListImmediate& RHICmdList, const FViewInfo& View, ESceneDepthPriorityGroup, bool PortalVisibilePass);
